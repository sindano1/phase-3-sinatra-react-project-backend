...
c1 = DogClass.create(date: Date.new(2022, 01, 31), lesson_id: l1.id, dog_id: d12.id)
c2 = DogClass.create(date: Date.new(2022, 01, 31), lesson_id: l1.id, dog_id: d14.id)
c3 = DogClass.create(date: Date.new(2022, 01, 31), lesson_id: l1.id, dog_id: d2.id)

c4 = DogClass.create(date: Date.new(2022, 02, 15), lesson_id: l2.id, dog_id: d6.id)
c5 = DogClass.create(date: Date.new(2022, 02, 15), lesson_id: l2.id, dog_id: d10.id)

c6 = DogClass.create(date: Date.new(2022, 02, 22), lesson_id: l3.id, dog_id: d1.id)
c7 = DogClass.create(date: Date.new(2022, 02, 22), lesson_id: l3.id, dog_id: d5.id)
c8 = DogClass.create(date: Date.new(2022, 02, 22), lesson_id: l3.id, dog_id: d4.id)

c9 = DogClass.create(date: Date.new(2022, 03, 01), lesson_id: l3.id, dog_id: d1.id)
c10 = DogClass.create(date: Date.new(2022, 03, 01), lesson_id: l3.id, dog_id: d5.id)
c11 = DogClass.create(date: Date.new(2022, 03, 01), lesson_id: l3.id, dog_id: d4.id)

c12 = DogClass.create(date: Date.new(2022, 01, 15), lesson_id: l4.id, dog_id: d4.id)
c13 = DogClass.create(date: Date.new(2022, 01, 31), lesson_id: l4.id, dog_id: d3.id)

c14 = DogClass.create(date: Date.new(2022, 02, 13), lesson_id: l5.id, dog_id: d3.id)
c15 = DogClass.create(date: Date.new(2022, 02, 14), lesson_id: l5.id, dog_id: d4.id)
c16 = DogClass.create(date: Date.new(2022, 01, 31), lesson_id: l5.id, dog_id: d8.id)

c17 = DogClass.create(date: Date.new(2022, 04, 16), lesson_id: l6.id, dog_id: d3.id)
c18 = DogClass.create(date: Date.new(2022, 04, 16), lesson_id: l6.id, dog_id: d4.id)
c19 = DogClass.create(date: Date.new(2022, 04, 16), lesson_id: l6.id, dog_id: d7.id)
c20 = DogClass.create(date: Date.new(2022, 04, 16), lesson_id: l6.id, dog_id: d8.id)
c21 = DogClass.create(date: Date.new(2022, 04, 16), lesson_id: l6.id, dog_id: d9.id)
c22 = DogClass.create(date: Date.new(2022, 04, 16), lesson_id: l6.id, dog_id: d10.id)

c23 = DogClass.create(date: Date.new(2022, 03, 15), lesson_id: l7.id, dog_id: d11.id)
c24 = DogClass.create(date: Date.new(2022, 03, 15), lesson_id: l7.id, dog_id: d12.id)
c25 = DogClass.create(date: Date.new(2022, 03, 15), lesson_id: l7.id, dog_id: d13.id)
c26 = DogClass.create(date: Date.new(2022, 03, 15), lesson_id: l7.id, dog_id: d4.id)

c27 = DogClass.create(date: Date.new(2022, 03, 01), lesson_id: l8.id, dog_id: d4.id)
c28 = DogClass.create(date: Date.new(2022, 03, 02), lesson_id: l8.id, dog_id: d6.id)
c29 = DogClass.create(date: Date.new(2022, 03, 03), lesson_id: l8.id, dog_id: d9.id)
c30 = DogClass.create(date: Date.new(2022, 03, 04), lesson_id: l8.id, dog_id: d14.id)
